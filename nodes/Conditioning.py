...
"""
    ...
    def switch(self, clip, Type, width, height, size_cond_factor, text1, text2):
        ...
        if Type == 1:
            return self.condconcat(cond1, cond2)
        elif Type == 2:
            return self.condconcat(cond2, cond1)
        elif Type == 3:
            return self.execute(clip, width, height, size_cond_factor, text1 + text2)
        elif Type == 4:
            return self.execute(clip, width, height, size_cond_factor, text2 + text1)
        else:
            return self.execute(clip, width, height, size_cond_factor, text1)
